  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 py-24 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-electric/20 rounded-full blur-[120px] animate-float" />

        <div
          className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-cyan/20 rounded-full blur-[100px] animate-float"
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-8">
            ...
            <span className="text-sm font-medium text-gray-300">
              Over 50,000+ Consultations Completed
            </span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            Experience the future of medicine. Connect with top specialists,
            get AI-powered triage, and receive instant digital prescriptions
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/how-it-works">
              <button
                type="button"
                className="px-8 py-4 rounded-full border border-white/20 text-white font-semibold hover:bg-white/5 transition-colors w-full sm:w-auto text-lg"
              >
                How It Works
              </button>
            </Link>
        ...
        <div className="relative z-10 mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-5xl w-full">
          {[
            ...
            >
              ...
              <div className="text-sm text-cyan uppercase tracking-wider">
                {stat.label}
              </div>
            </GlassPanel>
          ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <GlassPanel className="group hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-400">
                Crystal clear peer-to-peer video calls with ultra-low latency,
                ensuring you do not miss a detail during your session.
              </p>
            </GlassPanel>
            ...
            <GlassPanel className="group hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-400">
                Our advanced AI analyzes your symptoms instantly and recommends
                the most appropriate specialist for your condition.
              </p>
            </GlassPanel>
            ...
            <GlassPanel className="group hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-400">
                Receive cryptographically signed PDF prescriptions directly to
                your device immediately after your consultation.
              </p>
            </GlassPanel>
          </div>
        </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-cyan/5 rounded-l-full blur-3xl" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">
              See what our users have to say about MediConnect.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                name: "Priya S.",
                desc: "The video quality was amazing and the doctor was very professional. Saved me a trip to the hospital!",
                rating: 5,
              },
              {
                name: "Rahul V.",
                desc: "I used the AI triage which immediately suggested I see a dermatologist. Got my prescription in 15 mins.",
                rating: 5,
              },
              {
                name: "Anitha K.",
                desc: "Very easy to use interface. The digital prescription was accepted by my local pharmacy without any issues.",
                rating: 4,
              },
            ].map((review, i) => (
              <GlassPanel key={i} className="flex flex-col h-full">
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, j) => (
                    <Star
                      key={j}
                      className={`w-5 h-5 ${j < review.rating
        ...
        <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-br from-electric/20 to-cyan/20 border border-cyan/30 p-12 text-center relative overflow-hidden glass-morphism">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-cyan-light mb-8 max-w-2xl mx-auto">
              Join thousands of patients who have already switched to smarter
              healthcare.
            </p>
